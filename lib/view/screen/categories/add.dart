...
class CategoriesAdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    CtegoriesAddController controller = Get.put(CtegoriesAddController()) ;
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Category'),
      ),
      body: GetBuilder<CtegoriesAddController>(builder: (controller) => HandlingDataView(statusRequest: controller.statusRequest!,
       widget:  Container(
